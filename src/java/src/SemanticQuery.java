...
public class SemanticQuery {
    ...
    public ArrayList queryVirtuosoResourceNew(String search_word,int numberRecords, int offset ) {
...
//                                    + "}limit 20 offset " + numOffset + "";
                                ...
                                queryString = ""
                                        ...
                                        + "}"
                                        + "}limit "+ numberRecords +" offset "+offset;
...
//            }
    ...
    public String getDateStampResource(String idResource)throws MalformedQueryException, RepositoryException, UnsupportedEncodingException {
       String dateStamp="";
        try {
             ...
             String queryString = "prefix myOnto:<http://semanticweb.org/ontologies/2013/2/7/RepositoryOntology.owl#>"
                    ...
                    while (result.hasNext()) {
                        BindingSet bindingSet = result.next();
                         ...
                         dateStamp = bindingSet.getValue("date").stringValue();
     ...
     public ArrayList getDatesResource(String idResource)throws MalformedQueryException, RepositoryException, UnsupportedEncodingException {
        ...
        try {
             ...
             String queryString = ""
                    ...
                    while (result.hasNext()) {
                        ...
                        String date = bindingSet.getValue("date").stringValue();
...
//                    + "}";
    ...
    public void testFile(InputStream s) {

        System.out.println("*****************CERCO IL FILE*****************");
        System.out.println("*****************CERCO IL FILE*****************" + s.toString());
        ...
        if (s != null) {
            ...
            System.out.println("*****************TROVO IL FILE*****************");
            try {
...
//                }
    ...
    public String[] executeCommand(String title, String path) {
        ...
        String[] command = new String[]{"python", path, "-c 1", "--phrase", title};
