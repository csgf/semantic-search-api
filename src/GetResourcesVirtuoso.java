 ...
 */
@Path("resources")
public class GetResourcesVirtuoso {

    public static RepositoryConnection virtuosoConnection;
    public static String graph = "http://CHAIN-Reds_Test";
    private GetListResourcesVirtuoso myResource;
    // private GetCitationsGScholarResource infoGS;
    //private RepositoryResource myRepository;
    SemanticQuery query = new SemanticQuery();

    /**
     * Creates a new instance of GetResourcesVirtuoso
     */
    public GetResourcesVirtuoso() {
    }

    /**
     * Retrieves representation of an instance of src.GetResourcesVirtuoso
     *
     * @return an instance of java.lang.String
     */
    @GET
    @Produces("application/json")
    public GetListResourcesVirtuoso getListResourceVirtuoso(@QueryParam("keyword") String keyword, @QueryParam("limit") int numResource, @QueryParam("offset") int numOffset) throws IOException {
        ...
        try {
            ...
            myResource = new GetListResourcesVirtuoso();
            ...
            for (int i = 0; i < listResource.size(); i++) {
                ...
                resourceVirtuoso.setIdResource(idResource);
                ...
                for (int j = 0; j < identifiers.size(); j++) {
                    if (identifiers.get(j).toString().contains("doi")) {
                        if (!(identifiers.get(j).toString().contains("info"))) {
                            doi = identifiers.get(j).toString().substring(5);
                        } else {
                            doi = identifiers.get(j).toString().substring(9);
                        }
                ...
                ArrayList dates = query.getDatesResource(idResource);
                resourceVirtuoso.setDate(dates);



                String dateStamp = query.getDateStampResource(idResource);
                resourceVirtuoso.setDateStamp(dateStamp);
...
//                CitationsGScholarResource GScholarResource=new CitationsGScholarResource();
//                String [] infoGS=query.executeCommand(titles.get(0).toString(), pathGSCholar);
//                GScholarResource.setURL(infoGS[0]);
//                GScholarResource.setversions(infoGS[1]);
//                GScholarResource.setversionsList(infoGS[2]);
//                GScholarResource.setcitations(infoGS[3]);
//                GScholarResource.setcitationsList(infoGS[4]);
//                GScholarResource.setyear(infoGS[5]);
//                resourceVirtuoso.setCitationsGScholar(GScholarResource);


                myResource.getResources().add(resourceVirtuoso);
            ...
            Logger.getLogger(GetResourcesVirtuoso.class.getName()).log(Level.SEVERE, null, ex);
        ...
        System.out.println("chiamata api terminata--->" + myResource.getResources().size());
        return myResource;
    }
